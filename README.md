...
![An example of partial extract from the CSV formatted version](https://github.com/qiuyangnie/earthquakes/blob/master/img/csv_extract.jpg)
...
![Iterative Implementation](https://github.com/qiuyangnie/earthquakes/blob/master/img/p09.jpg)
